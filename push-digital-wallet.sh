#!/usr/bin/env bash
# ══════════════════════════════════════════════════════════════
#  GYDS — Push your-digital-wallet changes to GitHub
#
#  Usage:
#    GH_TOKEN=xxx bash push-digital-wallet.sh --msg "..."
# ══════════════════════════════════════════════════════════════
set -euo pipefail
...
CLONE_DIR="/tmp/gyds-push/your-digital-wallet"
...
REMOTE="https://${GH_TOKEN}@github.com/${GH_USER}/your-digital-wallet.git"
SRC="${WORKSPACE_DIR}/your-digital-wallet"

echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║   your-digital-wallet — Push to GitHub              ║"
echo "╚══════════════════════════════════════════════════════╝"
echo "  User   : ${GH_USER}"
...
if [[ -d "${CLONE_DIR}/.git" ]]; then
  ...
  log "Cloning your-digital-wallet..."
  rm -rf "$CLONE_DIR"
...
if [[ "$CHANGED" -eq 0 ]]; then
  echo -e "${GREEN}✓${NC} your-digital-wallet — nothing changed, already up to date"
  exit 0
fi
...
echo ""
echo -e "${GREEN}✓${NC} your-digital-wallet pushed → https://github.com/${GH_USER}/your-digital-wallet"
